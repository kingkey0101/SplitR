...
export const TESTIMONIALS = [
  {
    quote:
      "Yes! With Splitr, I finally stopped getting confused about who paid for what!",
    name: "Benny B.",
  ...
  {
    quote:
      "Splitr's calculations are so accurate, even better than my usual expense tracking app.",
    name: "Ralph R.",
  ...
  {
    quote:
      "Now that I have Splitr, keeping up with my finacess has never been easier! No more worrying about debt!",
    name: "Sally M.",
